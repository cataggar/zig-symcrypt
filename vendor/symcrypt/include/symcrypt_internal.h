...
#include <arm_neon.h>
    ...
    #if defined(SYMCRYPT_ZIG_IMPORT)
        typedef UINT8 SYMCRYPT_ZIG_N128 __attribute__((vector_size(16)));
        typedef UINT8 SYMCRYPT_ZIG_N64 __attribute__((vector_size(8)));
        #define __n128 SYMCRYPT_ZIG_N128
        #define __n64 SYMCRYPT_ZIG_N64

        #define SYMCRYPT_SET_N128_U64(d0, d1) \
            ((__n128) ((UINT64[2]) {d0, d1}))
        #define SYMCRYPT_SET_N64_U64(d0) \
            ((__n64) ((UINT64[1]) {d0}))
        #define SYMCRYPT_SET_N128_U8(b0, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, b11, b12, b13, b14, b15) \
            ((__n128) ((UINT8[16]) {b0, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, b11, b12, b13, b14, b15}))
    #elif SYMCRYPT_MS_VC
